...
describe 'audit::default' do
  ...
  context 'When two profiles are specified' do
    let(:chef_run) do
      ...
      runner.node.override['audit']['profiles'] = [ { 'name': 'myprofile', 'compliance': 'admin/myprofile' }, { 'name': 'ssh', 'compliance': 'snpautomation/ssh' } ]
  ...
  context 'When specifying profiles with alternate sources' do
    let(:chef_run) do
      ...
      runner.node.override['audit']['profiles'] = [
        { 'name': 'linux', 'compliance': 'snpautomation/linux' },
        { 'name': 'apache', 'compliance': 'snpautomation/apache' },
